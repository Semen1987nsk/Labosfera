...
Оптимизировано для виртуального хостинга REG.RU
"""
...
SECRET_KEY = os.getenv('SECRET_KEY', 'django-insecure-change-this-key-for-hosting')
...
# Кэширование (файловое для хостинга)
CACHES = {
    'default': {
