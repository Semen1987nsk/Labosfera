...
const storySteps = [
  {
    ...
    description: "Существующие решения на рынке не отвечали нашим высоким стандартам качества. Учителя и ученики заслуживают лучшего — оборудования мирового уровня",
    color: "from-red-500 to-orange-500"
  },
  {
    icon: HeartIcon,
    title: "Поставили амбициозную цель",
    description: "Создать продукты высочайшего качества мирового уровня. Чтобы каждый урок физики и химии превращался в увлекательное открытие, а учеба приносила истинное удовольствие",
