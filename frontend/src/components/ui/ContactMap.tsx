...
export const ContactMap = () => {
  ...
  // Координаты для примера (Москва, центр)
  const coordinates = {
    lat: 55.7558,
    lng: 37.6176
  };
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="relative h-64 bg-dark-blue rounded-lg overflow-hidden border border-white/10">
        <iframe
          src={`https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2244.3!2d${coordinates.lng}!3d${coordinates.lat}!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2zNTXCsDQ1JzIwLjkiTiAzN8KwMzcnMDIuMiJF!5e${mapType === 'satellite' ? '1' : '0'}!3m2!1sru!2sru!4v1234567890123!5m2!1sru!2sru`}
          width="100%"
          height="100%"
          style={{ border: 0 }}
          allowFullScreen
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
        <div className="flex items-center space-x-2">
          ...
          <span className="text-light-grey/80">5 мин пешком от метро</span>
        </div>
        <div className="flex items-center space-x-2">
          <svg className="w-4 h-4 text-electric-blue" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4" />
          </svg>
          <span className="text-light-grey/80">Бизнес-центр, 3 этаж</span>
        </div>
        <div className="flex items-center space-x-2">
          <svg className="w-4 h-4 text-electric-blue" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <div className="bg-electric-blue/10 rounded-lg p-4 border border-electric-blue/20">
        ...
        <ul className="text-sm text-light-grey/80 space-y-1">
          <li>• От метро «Примерная» выход №2, 5 минут пешком</li>
          <li>• На автомобиле: парковка в подземном гараже</li>
          <li>• Вход через главный вход бизнес-центра</li>
          <li>• Офис находится на 3 этаже, офис 301</li>
        </ul>
      </div>
    </div>
  );
