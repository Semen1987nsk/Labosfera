...
const values = [
  {
    title: "Мирового уровня",
    subtitle: "Качество без компромиссов",
    description: "Каждый продукт ЛАБОСФЕРЫ соответствует самым высоким международным стандартам",
    ...
    <section ref={ref} className="py-20 bg-gradient-to-br from-dark-blue to-slate-900 relative overflow-hidden">
      ...
      <Container className="relative z-10">
        ...
        >
          ...
          >
            Мы верим, что качественное оборудование способно изменить отношение к учебе навсегда
          </motion.p>
        </motion.div>
